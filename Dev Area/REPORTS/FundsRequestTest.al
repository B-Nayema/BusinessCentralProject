report 50081 "Funds Request Invoice"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layout/FundsRequestInvoice.rdlc';
    //Caption = 'Order Confirmation';
    Caption = 'Funds Request Invoice';
    ...
    dataset
    {
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            /*  column(GrantCode; "Sales Header"."Fund No. NVG")
             {
             } */
            column(FunderReference; "Sales Header"."Your Reference")
            {
            }
            ...
            /*  column(CreatedBy; "Sales Header"."Created By NVG")
             {
             } */
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(BankTransit; BankAcc."Transit No.")
                    {
                    }
                    column(BankIBAN; BankAcc.IBAN)
                    {
                    }
                    column(BankSWIFT; BankAcc."SWIFT Code")
                    {
                    }
                    column(BankBranch; BankAcc."Bank Branch No.")
                    {
                    }
                    column(BankName; BankAcc.Name)
                    {
                    }
                    column(BankAddress; BankAcc.Address)
                    {
                    }
                    column(BankCity; BankAcc.City)
                    {
                    }
                    column(BankContact; BankAcc.Contact)
                    {
                    }
                    column(BankCountry; BankAcc."Country/Region Code")
                    {
                    }
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        dataitem(AsmLoop; "Integer")
                        {
                            ...
                            // column(AsmLineNo; BlanksForIndent + AsmLine."No.")//BC UPG 1-REFF MISSING @@HA
                            // {
                            // }
                            // column(AsmLineDescription; BlanksForIndent + AsmLine.Description)//BC UPG 1-REFF MISSING @@HA
                            // {
                            // }
                ...
                begin
                    ...
                    // SalesPostPrepmt.BuildInvLineBuffer2("Sales Header", PrepmtSalesLine, 0, PrepmtInvBuf);//BC UPG 1-REFF MISSING @@HA
            ...
            trigger OnAfterGetRecord()
            begin
                //CurrReport.Language := Language.GetLanguageID("Language Code");//BC UPG 1-REFF MISSING @@HA
                ...
                if "Sales Header"."Bal. Account No." <> '' then
                    BankAcc.Get("Sales Header"."Bal. Account No.");

                if Print then begin
                    //BC UPG 1-REFF MISSING @@HA
                    // if CurrReport.UseRequestPage and ArchiveDocument or;
                    //    not CurrReport.UseRequestPage and SalesSetup."Archive Quotes and Orders"//BC UPG 1-REFF MISSING @@HA
                    //then
                ...
                //    if "Sales Header"."Document Status" > "Sales Header"."Document Status"::"Approval Pending"
                //       then begin
                //         ApprovalLine.Reset;
                //         ApprovalLine.SetRange(ApprovalLine."Document No.", "Sales Header"."No.");
                //         ApprovalLine.SetRange(ApprovalLine."Open/History", ApprovalLine."Open/History"::History);
                //         ApprovalLine.SetRange(Decision, ApprovalLine.Decision::Approved);
                //         if ApprovalLine.FindFirst then begin
                //             ApprovedBy := ApprovalLine."Action ID";
                //             DateApproved := ApprovalLine."Decision Date";
                //         end; 
                //     end;
            end;
    ...
    requestpage
    {
        ...
        trigger OnOpenPage()
        begin
            // ArchiveDocument := SalesSetup."Archive Quotes and Orders";//BC UPG 1-REFF MISSING @@HA
    ...
    var
        ...
        DateApproved: Date;
        ApprovedBy: Code[60];
    //ApprovalLine: Record "Approval Processing Line NVG";
